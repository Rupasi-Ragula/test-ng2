...
public class PositiveTests {
	...
	public void registrationTest()
	{
		...
		driver.findElement(By.name("name")).sendKeys("rupasi");
		sleep(1500);
		driver.findElement(By.name("email")).sendKeys("rupasiragula@gmail.com");
		sleep(1500);
		driver.findElement(By.name("password")).sendKeys("Rupasi*24");
		sleep(1500);
		driver.findElement(By.name("phone")).sendKeys("9014582817");
		sleep(1500);
...
//				new RemoteWebDriver(new URL("http://10.128.0.2:4444/wd/hub"),DesiredCapabilities.chrome());
	    ...
	    try {
            FileUtils.copyFile(scr, new File("C:\\Users\\rupas\\screenshots\\positivetest.png"));
        } catch (IOException e) {
